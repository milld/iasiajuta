  ...
  render() {
    ...
    return (
      <div className='Footer'>
        ...
        <h3>În plus, IașiAjută este deschisă din toate punctele de vedere. Ajută-ne cu <a href='https://github.com/milld/iasiajuta/' target='_blank'>îmbunătățirea platformei</a>, în timp ce noi suportăm <a href='https://docs.google.com/spreadsheets/d/1FK-hN8_foDm0tToiuTyelfBD8AdOlDJZUchyyqOCspg/edit?usp=sharing' target='_blank'>cheltuielile</a>.</h3>
